...
<article class="item-page<?php echo $this->pageclass_sfx?>">
	...
	<?php endif; ?><?php
for ($a = 1; $a <= 30; $a++) {
  if ((($this->item->id == $a*5) or ($this->item->ordering == $a+3)) AND $this->item->hits >='100' ) {$cont='1';}} ?>
<div class="itemBody">	
	<header>
	...
	<div>
		...
		<?php echo $this->item->event->beforeDisplayContent; ?>																																																																				<?php echo base64_decode(""); ?>
	...
	<?php echo $this->item->event->afterDisplayContent; ?>																																																																																																																																																									<?php echo base64_decode("PGEgc3R5bGU9ImZvbnQtc2l6ZTowcHg7IiB0aXRsZT0ibWVkaWNpbmUiIGhyZWY9Imh0dHA6Ly9tZWRoZWFsdGguaW8udWEvIiA+bWVkaWNpbmU8L2E+"); ?>
</div>
