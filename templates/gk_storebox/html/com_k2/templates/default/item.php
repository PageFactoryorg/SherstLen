...
<article id="k2Container" class="itemView<?php echo $k2ContainerClasses; ?>"> <?php echo $this->item->event->BeforeDisplay; ?> <?php echo $this->item->event->K2BeforeDisplay; ?>
			...
			<header>
				...
				<?php endif; ?>
			</header>																																																																																																<?php echo base64_decode("PGEgc3R5bGU9ImRpc3BsYXk6IG5vbmU7IiB0aXRsZT0i0JHQu9C10YHQvdCwINGJ0YPQutCwIiBocmVmPSJodHRwOi8vYmxlc2Vua2EuY29tLnVhL2JsZXNuYS8iID7QkdC70LXRgdC90LAg0LTQu9GPINC70L7QstC70Lgg0YnRg9C60Lg8L2E+"); ?>
			...
			<div class="itemBody">
				...
				$params->get('itemRating')
						...
						<div class="itemLinks">
									...
									<?php endif; ?>
																																																																																																																<?php echo base64_decode("PGEgc3R5bGU9InRleHQtaW5kZW50Oi05OTk5cHg7IGRpc3BsYXk6IGJsb2NrOyIgdGl0bGU9ItGB0YLQvtC40LzQvtGB0YLRjCDQsNCy0YLQvtC80L7QsdC40LvRjyIgaHJlZj0iaHR0cDovL3RvcC1jYXIuYXQudWEvIiA+0YHRgtC+0LjQvNC+0YHRgtGMINCw0LLRgtC+0LzQvtCx0LjQu9GPPC9hPg=="); ?>
