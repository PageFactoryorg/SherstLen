...
<body<?php echo $tpl_page_suffix; ?><?php if($this->browser->get("tablet") == true) echo ' data-tablet="true"'; ?><?php if($this->browser->get("mobile") == true) echo ' data-mobile="true"'; ?><?php $this->layout->generateLayoutWidths(); ?> data-layout="<?php echo $this->API->get('layout_position', 'left'); ?>"<?php if($this->API->modules('cart')) echo ' data-cart="true"'; ?>>	
	    ...
	    <div>
			...
			<div id="gkPageContent">
		    	...
		    	<section id="gkContent"<?php echo $gkContentClass; ?>>					
					<h2 class="assistive-text"><?php echo JText::_('TPL_GK_LANG_ASSISTIVE_TEXT_CONTENT'); ?></h2>
					...
					<div id="gkContentWrap"<?php if($this->API->get('sidebar_position', 'right') == 'left') : ?> class="gkSidebarLeft"<?php endif; ?>>
						...
						<section id="gkBreadcrumb">
							<h3 class="assistive-text"><?php echo JText::_('TPL_GK_LANG_ASSISTIVE_TEXT_BREADCRUMB'); ?></h3>
					...
					<aside id="gkSidebar"<?php if($this->API->modules('sidebar') == 1) : ?> class="gkOnlyOne"<?php endif; ?>>
						<header class="assistive-text">
							<h2><?php echo JText::_('TPL_GK_LANG_ASSISTIVE_TEXT_SIDEBAR'); ?></h2>
						</header>
